...
module.exports = {
  SESSION_ID: '',
  ALIVE_REACT: '👋',
  ALIVE_MESSAGE: `*Kon'nichiwa @name [ And @gname @members Number of Members ] I am Alive Now !*
...
Qᴜᴇᴇɴ ᴇʟɪꜱᴀ ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ`,
  ...
  STICKER_AUTHOR: '𝓡𝓲𝓸(リオ)🍃🌸',
  STICKER_PACK: '𝐐𝐔𝐄𝐄𝐍 𝐄𝐋𝐈𝐒𝐀™',
  REMOVE_BG_APIKEY: '',
  MAXIMUM_FILESIZE: 90,
  OWNER_R_EMOJI: '📛,
  ALIVE_AS_GIF: true,
  ...
  MSG: {
    ...
    GROUP_LEAVE: '👋🏻 Sayonara @groupName I am Going.',
    INBOX_BLOCK:
